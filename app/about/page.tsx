    ...
    <div className="space-y-12">
      ...
      <div className="flex flex-col md:flex-row items-center md:items-start space-y-8 md:space-y-0 md:space-x-12">
        ...
        <div className="space-y-6 max-w-2xl">
          <p className="text-lg">
            Greetings, I'm Gnanaraj "0xm3m" Mauviel, a passionate ethical hacker and cybersecurity researcher with over a decade of experience in the field. My mission is to uncover vulnerabilities, strengthen digital defenses, and make the online world a safer place for everyone.
          </p>
          <p className="text-lg">
